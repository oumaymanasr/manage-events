...
const routes: Routes = [
    {
        ...
        "children": [
            {
                "path": "formationangular",
                "loadChildren": ".\/pages\/formationangular\/formationaugular.module#FormationangularModule"
            },
            {
                "path": "formation",
                "loadChildren": ".\/pages\/default\/components\/formation\/formation.module#FormationModule"
            },
            {
